...
int launchJVM(NSString *username, id launchTarget, int width, int height, int minVersion) {
    ...
    asprintf(&frameworkPath, "-Djava.library.path=%1$s/Frameworks:%1$s/Frameworks/libOSMesa.8.dylib.framework:%1$s/Frameworks/libMoltenVK.dylib.framework", getenv("BUNDLE_PATH"));
